...
"""
    ...
    """
class FormulaLiquid:
    """Modèle hydraulique basé sur la limite de liquidité (wL).

    Calcule kv, Ei, E0, σ0, ainsi que Cc et Ck. Utiliser `calculate(...)`.
    ...
    def formula12(self):
        """Calcule e0 en fonction de ei et wL."""
    ...
    def formula15(self):
        """Calcule kv0 en fonction de e0 et wL."""
        exponent = -0.25 * self.type_sol + (0.08 * self.type_sol + 12.85) * self.e0
        self.kv0 = 3* 1.3 * (10 ** (-8)) * math.exp(exponent)
